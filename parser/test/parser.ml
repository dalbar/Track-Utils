...
let wav_mixed =
  "1992/v_Chez Damier feature Alu & Mic - Can You Feel It (more info (a b c)) \
   (A 2 1:2 Step (version plus 1) (version plus 2 (useless add))).wav"
...
let mp3_3 =
  "1mp3/Black & Marty ft random - Wonderful Life (more info for title) (Nick \
   Tohme Bootleg (Special Version) (Mix)).2011.mp3"

let mp3_4 = "1mp3/Jamie Woon - Night Air (Official Video).2010.mp3"

let mp4_mixed_frensh =
  "1m4a/Yann Tiersen - Comptine D'Un Autre Été, L'Après-Midi (Live).2008.m4a"
...
let test_tokenizer_simple_wav_token () =
  ...
  Alcotest.(check string)
    "Simple Wav without version" wav_token_string token_string

let tests = [("Test tokenizer", `Quick, test_tokenizer_simple_wav_token)]
